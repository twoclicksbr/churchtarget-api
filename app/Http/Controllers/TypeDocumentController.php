...
{
    protected string $tableName = 'type_document';
    protected string $tableLabel = 'type_document';
    protected string $modelName = 'TypeDocument';
    ...
    public function index(Request $request)
    {
        ...
        return response()->json([
            ...
            'available_filters' => [
                ...
                'name' => 'string',
                'input_type' => 'text, number, email etc',
                'active' => '0 ou 1',
